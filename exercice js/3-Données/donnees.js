...
let string3 = `mon chien fait ${number} cm de long` // Si j'utilise les accents grave pour déclarer une chaine de caractère je dois utiliser un littéral de gabarit pourn déclarer l'utilisation d'une variable dans la chaine de caractère
